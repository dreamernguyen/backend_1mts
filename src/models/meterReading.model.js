...
const meterReadingSchema = new mongoose.Schema({
    ...
    aiSessionId: { type: String, trim: true, maxlength: 150, default: null },
    ocrEngine: { type: String, enum: ['GEMINI', 'ML_KIT', 'MANUAL', 'UNKNOWN'], default: 'UNKNOWN' },
    clientPlatform: { type: String, enum: ['WEB', 'ANDROID', 'IOS', 'DESKTOP', 'UNKNOWN'], default: 'UNKNOWN' },
